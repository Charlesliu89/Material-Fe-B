...
Suggestion: run tools/lit_search.py locally with outbound access and set CROSSREF_MAILTO / OPENALEX_MAILTO / OPENALEX_API_KEY as needed, or provide a manual candidates list to the pipeline with --candidates sources/manual_candidates.json.
