#!/usr/bin/env python3
"""Convert PDFs in sources/ to text for extraction."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Convert PDFs under sources/ to .txt")
    parser.add_argument(
        "inputs",
        nargs="*",
        default=["sources"],
        help="PDF files or directories to scan (default: sources)",
    )
