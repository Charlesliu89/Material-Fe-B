...
def main() -> int:
    parser = argparse.ArgumentParser(description="Merge extracted TDB lines into tdb/Fe-B.tdb")
    parser.add_argument("--template", default="tdb/template.tdb", help="Template TDB path")
    parser.add_argument("--output", default="tdb/Fe-B.tdb", help="Output TDB path")
