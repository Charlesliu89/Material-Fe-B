#!/usr/bin/env python3
"""Download open-access sources into sources/<doi_or_slug>/"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Fetch OA sources into sources/<slug>/")
    ...
    parser.add_argument("--out", default="sources", help="Output directory")
